...
/** \brief Ejecuta la funcion recibida como parametro por cada item de la lista recibida
 *
 * \param pList LinkedList* Puntero a la lista
 * \return int retorno  (-1) Error: si el puntero a la lista o a la funcion son NULL,
						(0) Si ok
*/
...
{
	LinkedList* pFiltered=NULL;
	pFiltered=ll_newLinkedList();
	void* pAuxElement;
	int i;
	if(	this!=NULL &&
		*pFunc!=NULL)
